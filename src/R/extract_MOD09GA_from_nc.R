...
t1 <- arrow::read_parquet("outputs/notNA_pix_MOD09GA_red_AMC_2000-03-01_2023-07-01.parquet")
fp <- "data/processed_RS/MOD09GA_blue_to_green_AMC_2000-03-01_2023-10-29.nc"
r <- rast(fp)
