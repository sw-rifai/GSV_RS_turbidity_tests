...
fp1 <- "data/processed_RS/MOD09GA_red_AMC_2000-03-01_2023-07-01.nc"
fp2 <- "data/processed_RS/MYD09GA_red_AMC_2002-07-04_2023-10-29.nc"
# ===========================================
...
ss3 %>% 
  ...
  #             formula=y~s(x,bs='ad'))+
  coord_cartesian(ylim=c(0.0,0.1),expand=F) +
