...
vec_dates <- fread("data/gee_SAWater_turbidity/DATES_L3SMI_Rrs_645_daily_2002-07-03_2012-12-31.csv")
vec_dates2 <- fread("data/gee_SAWater_turbidity/DATES_L3SMI_Rrs_645_daily_2012-12-31_2023-07-01.csv")

ic <- rast("data/gee_SAWater_turbidity/L3SMI_Rrs_645_daily_2002-07-03_2012-12-31.tif")
ic2 <- rast("data/gee_SAWater_turbidity/L3SMI_Rrs_645_daily_2012-12-31_2023-07-01.tif")
...
cdat[date %in% seq(ymd("2016-10-01"),ymd("2016-11-01"),by="1 day")] %>% 
  ...
  scale_fill_viridis_c(option = 'B', 
                       ...
                       # limits = c(0,0.2),
                       oob = scales::squish) + 
  labs(fill = "Reflectance at 645 nm", 
  ...
  theme(axis.ticks.x = element_blank(),
        ...
        legend.position = 'bottom')
ggsave(filename = "figures/L3SMI_2016-10_map_red.png",
       width = 17,
       height = 25,
       units = 'cm',
       dpi = 350)
